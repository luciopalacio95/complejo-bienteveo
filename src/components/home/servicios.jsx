    ...
    return (
        <section className="mt-28 px-6 sm:px-28" id='servicios'>
            ...
            <p className="text-stone-900 text-2xl text-pretty mt-8 mb-5">
                Bienvenidos a Complejo Bienteveo, su hogar lejos de casa en el corazón de las sierras cordobesas, estamos ubicados a 10min de Villa Carlos Paz y a tan solo 50mts del río San Antonio. 
                <br></br>
