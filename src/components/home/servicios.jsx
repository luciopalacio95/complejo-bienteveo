    ...
    return (
        <section className="mt-28 px-6 sm:px-28" id='servicios'>
            ...
            <p className="text-stone-900 text-2xl text-pretty mt-8 mb-5">
                Bienvenidos a Complejo Bienteveo, su hogar lejos de casa en el corazón de las sierras cordobesas, a solo una cuadra del río. 
                <br></br>
            ...
            <div className='w-full flex flex-wrap gap-y-10 text-lg sm:text-2xl'>
            ...
            <div className="text-center mt-20">
                <a className="bg_inferior btn_calltoaction hover:opacity-80 text-white text-2xl font-medium px-6 py-3 border rounded-md" target='_blank' href="https://api.whatsapp.com/send?phone=543515730873&amp;text=Hola%20Complejo%20Bienteveo,%20quiero%20realizar%20una%20reserva...">Reserva tu estadía ahora</a>
            </div>
        </section>
    )
}