...
export default function Galeria(){
    const [openGallery1, setOpenGallery1] = useState(false);
    const [openGallery2, setOpenGallery2] = useState(false);
    const [openGallery3, setOpenGallery3] = useState(false);
            ...
            <div className='w-full flex flex-wrap gap-y-10 text-base sm:text-2xl mt-8 mb-5'>
                <div className="basis-2/2 sm:basis-1/3 text-pretty flex justify-stretch sm:items-center p-0 sm:p-4 mt-6">
                    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow bg_casa">
                        <a onClick={(e) => setOpenGallery1(true)} className='cursor-pointer'>
                        ...
                        <div className="p-5">
                            ...
                            <ModalGallery fotos={fotos.complejo} openGallery={openGallery1} setOpenGallery={setOpenGallery1}/>
                        </div>
                    </div>
                </div>
                <div className="basis-2/2 sm:basis-1/3 text-pretty flex justify-stretch sm:items-center p-0 sm:p-4 mt-6">
                    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow bg_casa">
                        <a onClick={(e) => setOpenGallery2(true)} className='cursor-pointer'>
                        ...
                        <div className="p-5">
                            ...
                            <ModalGallery fotos={fotos.pileta} openGallery={openGallery2} setOpenGallery={setOpenGallery2}/>
                        </div>
                    </div>
                </div>
                <div className="basis-2/2 sm:basis-1/3 text-pretty flex justify-stretch sm:items-center p-0 sm:p-4 mt-6">
                    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow bg_casa">
                        <a onClick={(e) => setOpenGallery3(true)} className='cursor-pointer'>
                        ...
                        <div className="p-5">
                            ...
                            <ModalGallery fotos={fotos.rio} openGallery={openGallery3} setOpenGallery={setOpenGallery3}/>
                        </div>
                    </div>
                </div>
            </div>
