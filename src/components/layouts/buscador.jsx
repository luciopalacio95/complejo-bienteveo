export default function Buscador(props){
    ...
    return (
        <form className="mt-16 sm:mt-10 bg-slate-100 p-10 w-fit sm:w-96" role="search" method="get" action="/buscar" >
                ...
                <div className="sm:col-span-6">
                    <div className="mt-2 flex">
                        <input type="search"
                            ...
                            className="block w-full text-xl border-none border-0 pl-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"
                        />
